...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const mockData: Certification[] = [
      { _id: '1', nome: 'John', cognome: 'Smith', azienda: 'Accenture', email: 'john@example.com', jobRole: 'Developer', dataCertificazione: '2024-01-15', tipoCertificazione: 'MongoDB Associate', country: 'USA', customer: 'Client A', deliveryModel: 'Onshore' },
      { _id: '2', nome: 'Maria', cognome: 'Garcia', azienda: 'Accenture', email: 'maria@example.com', jobRole: 'Data Analyst', dataCertificazione: '2024-02-20', tipoCertificazione: 'MongoDB Professional', country: 'Spain', customer: 'Client B', deliveryModel: 'Offshore' },
      { _id: '3', nome: 'James', cognome: 'Johnson', azienda: 'Accenture', email: 'james@example.com', jobRole: 'Architect', dataCertificazione: '2024-01-10', tipoCertificazione: 'MongoDB Expert', country: 'UK', customer: 'Client C', deliveryModel: 'Onshore' },
      { _id: '4', nome: 'Priya', cognome: 'Sharma', azienda: 'Accenture', email: 'priya@example.com', jobRole: 'Developer', dataCertificazione: '2024-03-05', tipoCertificazione: 'MongoDB Associate', country: 'India', customer: 'Client A', deliveryModel: 'Offshore' },
      { _id: '5', nome: 'Hans', cognome: 'Mueller', azienda: 'Accenture', email: 'hans@example.com', jobRole: 'Consultant', dataCertificazione: '2024-02-28', tipoCertificazione: 'MongoDB Professional', country: 'Germany', customer: 'Client D', deliveryModel: 'Onshore' },
      { _id: '6', nome: 'Liu', cognome: 'Wei', azienda: 'Accenture', email: 'liu@example.com', jobRole: 'Developer', dataCertificazione: '2024-01-25', tipoCertificazione: 'MongoDB Associate', country: 'China', customer: 'Client E', deliveryModel: 'Offshore' },
      { _id: '7', nome: 'Sarah', cognome: 'Brown', azienda: 'Accenture', email: 'sarah@example.com', jobRole: 'Team Lead', dataCertificazione: '2024-03-15', tipoCertificazione: 'MongoDB Expert', country: 'Canada', customer: 'Client F', deliveryModel: 'Onshore' },
      { _id: '8', nome: 'Alessandro', cognome: 'Rossi', azienda: 'Accenture', email: 'alessandro@example.com', jobRole: 'Architect', dataCertificazione: '2024-02-10', tipoCertificazione: 'MongoDB Professional', country: 'Italy', customer: 'Client G', deliveryModel: 'Onshore' },
      { _id: '9', nome: 'Yuki', cognome: 'Tanaka', azienda: 'Accenture', email: 'yuki@example.com', jobRole: 'Developer', dataCertificazione: '2024-01-30', tipoCertificazione: 'MongoDB Associate', country: 'Japan', customer: 'Client H', deliveryModel: 'Offshore' },
      { _id: '10', nome: 'Emma', cognome: 'Wilson', azienda: 'Accenture', email: 'emma@example.com', jobRole: 'Data Scientist', dataCertificazione: '2024-03-20', tipoCertificazione: 'MongoDB Professional', country: 'Australia', customer: 'Client I', deliveryModel: 'Offshore' },
    ];
    setData(mockData);
